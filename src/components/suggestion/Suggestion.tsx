...
const Suggestion = (props: {
    ...
    return (
        <div
            ...
            key={props.key}
            className="min-h-20 cursor-pointer justify-center text-center flex items-center text-[16px] font-mono rounded-xl sm:p-8 sm:py-4 p-4 py-2 w-full bg-light-100 dark:bg-dark-100"
        >
