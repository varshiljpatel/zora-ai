    ...
    return (
        <div className="relative w-full p-4 flex gap-x-4 sm:gap-x-8">
            <textarea
                ...
                className="focus:border-dark outline-none resize-none transition-all border-0 p-5 placeholder:text-dark bg-light-100 rounded-[24px] max-sm:min-h-32 min-h-24 w-full"
            ></textarea>
            <IconButton
