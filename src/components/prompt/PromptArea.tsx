        ...
        <>
            <div className={cn("w-full relative rounded-[40px] md:p-4 p-2 flex gap-x-2 justify-between items-end md:gap-x-4 min-h-16 bg-light-100 flex-none dark:bg-dark-100 max-h-44", promptValue.length > 0 ? "dark:bg-dark-300" : "")}>
                ...
                <textarea
                    ...
                    className="overflow-y-auto outline-none blockScroll p-4 resize-none transition-all border-0 placeholder:text-dark min-h-full dark:placeholder:text-neutral bg-transparent w-full max-h-full"
                ></textarea>
                <IconButton
